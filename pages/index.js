...
import "../sass/yui.scss"
export default () => (
  <div>
    <Head>
      <title>David Galindo - CV</title>
      <meta charSet='utf-8' />
    ...
    <div id="doc2" class="yui-t7">
  	<div id="inner">
  		<div id="hd">
  			<div class="yui-gc">
  				<div className="yui-u first">
  					<h1>David Galindo</h1>
  					<h2>Product, SEO & AdTech</h2>
  				</div>

  				<div class="yui-u">
  					<div class="contact-info">
  						<h3><a id="pdf" href="#">Print PDF</a></h3>
  						<h3><a href="mailto:dgalindoc@gmail.com">dgalindoc@gmail.com</a></h3>
  						<h3>619 63 43 11</h3>
  					</div>
  				</div>
  			</div>
  		...
  		<div id="ft">
  			<p>David Galindo &mdash; <a href="mailto:dgalindoc@gmail.com">dgalindoc@gmail.com</a> &mdash; 619 63 43 11</p>
  		</div>
